...
nohup /Users/zhuobao/.openclaw-rescue4/workspace/video-clipper/.venv/bin/uvicorn backend.main:app --host 0.0.0.0 --port 8000 --reload --reload-dir /Users/zhuobao/.openclaw-rescue4/workspace/video-clipper/backend > logs/backend_release.log 2>&1 < /dev/null &
BACKEND_PID=$!
